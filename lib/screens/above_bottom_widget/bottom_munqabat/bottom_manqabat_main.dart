...
class BottomManqabatMain extends StatelessWidget {
  const BottomManqabatMain({super.key});
  final String routeName = "/bottom_munqabat";
  @override
        ...
        child: SafeArea(
          child: Column(
            children: [
              ...
              BottomBody(onTap: () {
                Navigator.pushNamed(context, '/bottom_munqabat_detail');
              })
            ],
          ),
        ),
